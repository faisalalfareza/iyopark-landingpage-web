...
<html>
   <head>
      <title>IYOPARK | Track Your Parking Area</title>
      <meta charset="utf-8">
      ...
      <link rel="shortcut icon" type="image/x-icon" href="<?=base_img()."icon/eraser.png"?>">
...
<!--                <nav class="site-nav">
               ...
               <nav class="site-nav">
                  <ul class="clean-list site-links">
                      ...
                      <a id="modal_trigger" href="javascript:void(0)" class="btn btn-blue openLogin" style="box-shadow: 0px 3px 3px rgba(52, 52, 52, 0.15);">Masuk</a> 

                      <a href="#tentang" data-toggle="modal" class="btn btn-white" style="background-color:transparent;border:1px solid #3498db;color:#3498db;">Kerjasama</a>  
               ...
               <div class="container">
                  <div class="hero-text align-center">
                    <div class="col-md-12 first">
                     ...
                     <div class="title">
                     <img src="<?=base_img()."icon/eraser.png"?>" width="40px"> <br>
                     Pencatatan setiap transaksi perparkiran yang membantu pihak pengelola memantau pendapatan yang diperoleh dari lahan parkirnya</div>

                     <div class="quote">Selalu ada memberikan anda pengalaman parkir yang terbaik. Bagi Pengendara, Pengelola, dan Juru Parkir</div> 

                     <div class="quote" style="margin-top:0.8em;">
                        <span style="background-color:#fdfdfd;padding:5px;box-shadow: 2px 2px 15px rgba(52, 52, 52, 0.15);border-radius:3px;color:#3498db;margin:0.01em;">6</span>
                        <span style="background-color:#fdfdfd;padding:5px;box-shadow: 2px 2px 15px rgba(52, 52, 52, 0.15);border-radius:3px;color:#3498db;margin:0.01em;">5</span>
                        &nbsp; User telah mendukung kami
                     </div>
                    ...
                    <div class="col-md-12 last paddingme">  
                          ...
                          <div class="sidebar content-box left-box">
                              <ul class="nav">
                                  ...
                                  <li><a href="javascript:void(0)"><img src="<?=base_img()."icon/smartphone-1.png"?>"> &nbsp; Realtime Transaction & Monitoring</a></li>   
                                  <li><a href="javascript:void(0)"><img src="<?=base_img()."icon/megaphone.png"?>"> &nbsp; Bonus for Parkman Based on Service</a></li>                              
                                  <li><a href="javascript:void(0)"><img src="<?=base_img()."icon/checklist.png"?>"> &nbsp; Secure Guarantee Parking</a></li>
               ...
               <!-- <div class="row">            
                  <div class="col-md-8 col-sm-12 col-xs-24">
                     <div class="destination-box">
                        <div class="box-cover">
                           <a href="">
                                <img src="<?=base_img()."feed/1.jpg"?>" class="img-responsive" alt="">
                           </a>
                        </div>

                        <span class="boats-qty">Pelayanan kurang maksimal</span>

                        <div class="box-details">
                           <div class="box-meta">
                              <h4 class="city">Pelayanan kurang maksimal</h4>
                              <p class="country">Pesan tempat parkir yang Anda inginkan. Anda bisa memesan lama waktu parkir sampai dengan 12 jam, namun Anda harus memiliki deposit terlebih dahulu.</p>
                           </div>
                        </div>
                     </div>
                  </div> 
                  <div class="col-md-8 col-sm-12 col-xs-24">
                     <div class="destination-box">
                        <div class="box-cover">
                           <a href="">
                                <img src="<?=base_img()."feed/2.jpg"?>" class="img-responsive" alt="">
                           </a>
                        </div>

                        <span class="boats-qty">Jaminan Keamanan</span>

                        <div class="box-details">
                           <div class="box-meta">
                              <h4 class="city">Jukir Online</h4>
                              <p class="country">Pesan tempat parkir yang Anda inginkan. Anda bisa memesan lama waktu parkir sampai dengan 12 jam, namun Anda harus memiliki deposit terlebih dahulu.</p>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-md-8 col-sm-12 col-xs-24">
                     <div class="destination-box">
                        ...
                        <span class="boats-qty">Sistem Pembayaran</span>
                    ...
                    <form action="<?php echo base_url()."index.php/auth/collaboration"?>" method="post">
                        <div class="portlet-body visi-misi" style="padding:0;margin:0;border:0;">
                            <div class="col-md-12" style="padding:0;margin:0;border:0;">
                               ...
                               <a id="detail-tenant" class="btn tags-detail">Bergabung bersama kami ..</a>  

                              <img src="<?=base_img()."wrapper-img.gif"?>">
                            </div> 
                            <div class="col-md-12" style="padding:15px;">    
                                ...
                                <div class="action_btns">                           
                                  <div class="one_half"><button type="button" data-dismiss="modal" class="btn" style="font-weight:bold">Kembali</button></div>  
                                  <div class="one_half last"><button type="button" class="btn to-maksud-tujuan" style="font-weight:bold">Selanjutnya</button></div>  
                                </div> 
                        ...
                        <div class="portlet-body tugas-fungsi" style="padding:0;margin:0;border:0;">
                            ...
                            <div class="col-md-12" style="padding:15px;">    
                                    ...
                                    <div class="group-list">
                                        <div class="list-group-item">
                                            <div class="checkbox pull-left">
                                                <label>
                                                    <input type="radio" name="CollaborateStatus" value="Pengelola">                                        
                                                </label>   
                                            </div>
                                            <div class="pull-left form-control-inline-">
                                                <a href="" class="list-group-item-heading title">Pemilik, Pengelola & Penanggung Jawab Lahan Parkir</a>
                                        ...
                                        <div class="list-group-item">
                                            <div class="checkbox pull-left">
                                                <label>
                                                    <input type="radio" name="CollaborateStatus" value="Jukir">                                        
                                                </label>   
                                            </div>
                                            <div class="pull-left form-control-inline">
                                                <a href="" class="list-group-item-heading title">Juru Parkir</a>
                                        ...
                                        <div class="list-group-item">
                                            <div class="checkbox pull-left">
                                                <label>
                                                    <input type="radio" name="CollaborateStatus" value="Lainnya">                                        
                                                </label>   
                                            </div>
                                            <div class="pull-left form-control-inline">
                                                <a href="" class="list-group-item-heading title">Lainnya</a>
                                ...
                                <div class="action_btns">                           
                                  <div class="one_half to-maksud-tujuan"><button type="button" class="btn" style="font-weight:bold">Kembali</button></div>  
                                  <div class="one_half last"><button type="submit" class="btn" style="font-weight:bold">Gabung</button></div>  
                                </div> 
